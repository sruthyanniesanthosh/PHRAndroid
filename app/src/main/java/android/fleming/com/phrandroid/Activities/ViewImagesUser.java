...
public class ViewImagesUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rs=(RecyclerView)findViewById(R.id.rsView);
    ...
    public class getImageFromServer extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                httpURLConnection = (HttpURLConnection) new URL("http://192.168.43.81:16052/PHR/GetImages.jsp").openConnection();
...
try {
    ...
    adapter = new ViewImageAdapter(getApplicationContext(),array);
